    ...
    async sendVerificationEmail(email, token) {
        const url = 'YOUR_FRONTEND_VERIFICATION_URL_HERE'
            ...
            this.transporter.sendMail({
                ...
                html: `<h2>Hey!</h2> <br> <br> <p>Je moet nog één ding doen voor je kan beginnen browsen! <br> Klik op de volgende link op jouw e-mail te verifieren: <br> <br>  <a  href="${url}?token=${token}" style="background-color: #2B5740; padding: 6px; border: 12px solid;">Verify Email</a> <br> <br> Hopelijk tot snel! <br> Groetjes het Kwipper-team! </p>`
            });
        }
    };
